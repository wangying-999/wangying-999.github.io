    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="standard" label="规格" align="center" width="180">
                    
                </el-table-column>
              

                <el-table-column  label="购置日期" align="center" width="180">
                    <template slot-scope="scope">
                        <i class="el-icon-time"></i>
                        <span style="margin-left: 10px">{{ scope.row.buydata }}</span>
                    </template>
                </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-form-item label="购置日期">
                    <!-- <el-input v-model="form.buydata"></el-input> -->
                    <el-date-picker
                    v-model="form.buydata"               
                    type="date"
                    placeholder="选择日期"
...
export default {
    ...
    methods: {
        ...
        getData(){
            this.$http.get("/vue/data").then(res=>{
                ...
                let list = this.list.filter((item,index) =>
                    item.id.match(this.query.searchData) || item.assetname.match(this.query.searchData) || item.buydata.match(this.query.searchData)
                )
        ...
        saveEdit() {
            ...
            this.$http.post("/vue/editone",this.form).then(res=>{
                console.log(res);               
