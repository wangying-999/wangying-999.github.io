    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column  prop="place" label="存放地点" width="180" align="center">
                   
                </el-table-column>
                <el-table-column prop="equse" label="设备用途" align="center" width="180">
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-form-item label="设备用途">
                    <el-input v-model="form.equse"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        getData(){
            this.$http.get("/vue/data").then(res=>{
                ...
                let list = this.list.filter((item,index) =>
                    item.id.match(this.query.searchData) || item.assetname.match(this.query.searchData) || item.place.match(this.query.searchData)
                )
        ...
        saveEdit() {
            ...
            this.$http.post("/vue/editfour",this.form).then(res=>{
                console.log(res);               
