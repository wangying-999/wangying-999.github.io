            ...
            <el-tabs v-model="message">
                <el-tab-pane :label="`未读消息(${unread.length})`" name="first">
                    ...
                    <div class="handle-row">
                        <el-button type="primary" @click="allsign">全部标为已读</el-button>
                    </div>
                </el-tab-pane>
                <el-tab-pane :label="`已读消息(${read.length})`" name="second">
                    <template v-if="message === 'second'">
                        ...
                        <div class="handle-row">
                            <el-button type="danger" @click="alldelect">删除全部</el-button>
                        </div>
                    </template>
                </el-tab-pane>
                <el-tab-pane :label="`回收站(${recycle.length})`" name="third">
                    <template v-if="message === 'third'">
                        ...
                        <div class="handle-row">
                            <el-button type="danger" @click="all">清空回收站</el-button>
                        </div>
                    </template>
                </el-tab-pane>
            </el-tabs>
    ...
    export default {
        ...
        methods: {
            handleRead(index) {
                ...
                bus.$emit('message-content', this.unread.length);
            },
            handleDel(index) {
