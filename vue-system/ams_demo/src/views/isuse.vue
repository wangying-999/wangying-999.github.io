    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="id" label="资产编号" width="140" align="center"></el-table-column>
                <el-table-column prop="assetname" label="资产名称" align="center"></el-table-column>
                <el-table-column  prop="adminunit" label="管理单位" width="180" align="center">
                   
                </el-table-column>
                <el-table-column prop="useunit" label="使用单位" align="center" width="180">
                    
                </el-table-column>
              
                <el-table-column prop="admin" label="管理人" align="center" width="120">
                    
                </el-table-column>

                <el-table-column  label="领用日期" align="center" width="180">
                    <template slot-scope="scope">
                        <i class="el-icon-time"></i>
                        <span style="margin-left: 10px">{{ scope.row.usedata }}</span>
                    </template>
                </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="70px">
                ...
                <el-form-item label="管理单位">
                    <el-input v-model="form.adminunit"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        getData(){
            this.$http.get("/vue/data").then(res=>{
                ...
                let list = this.list.filter((item,index) =>
                    item.id.match(this.query.searchData) || item.assetname.match(this.query.searchData) || item.admin.match(this.query.searchData)
                )
        ...
        saveEdit() {
            ...
            this.$http.post("/vue/editthree",this.form).then(res=>{
                console.log(res);               
